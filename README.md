...
Background noise is added to the silence classification using recorded volume as the start point you should use audacity to test you mics record levels and normalise to similar and also maybe another set at half that volume again to vary your silence collection.
