...
parser.add_argument('-t', '--tempo', type=float, default=0.15, help='tempo percentage range')
...
parser.add_argument('-S', '--silence_percent', type=float, default=1.0, help='dataset silence percentage')
parser.add_argument('-n', '--notkw_percent', type=float, default=1.0, help='dataset notkw percentage')
...
parser.add_argument('-m', '--min_samples', type=int, default=400, help='minimum resultant samples')
